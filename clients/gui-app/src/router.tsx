 ...
 *
 * Exported for the test only. Reading `import.meta.env` at CALL time rather
 * than at module init is what makes it stubbable - a module-scope constant
 * would freeze whatever the test runner's base happened to be, and the test
