...
function ActiveTabBody(props: ActiveTabBodyProps) {
  ...
  // Terminals, git-diff tiles, the PR detail/diff pair, workspace files, and
  // blank tabs are renderer-only - no cloud-backed projection, so a lookup
  // miss isn't deletion. (A blank tab's content id is a throwaway uuid;
