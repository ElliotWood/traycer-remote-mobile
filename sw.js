...
const sw = self;
const __TRAYCER_SW_BUILD_ID__ = "0c211b36301b";
const __TRAYCER_SW_PRECACHE__ = ["/next/assets/ClientOnly-DnqEjYVN.js","/next/assets/app-version-tR5WPdwC.js","/next/assets/arrow-left-right-BbUATIak.js","/next/assets/arrow-right-DfKUuHzG.js","/next/assets/auth-error-toast-BKzhmX-l.js","/next/assets/chord-CDARcDeX.js","/next/assets/clock-CoyXy8G1.js","/next/assets/collapsible-C6oadDZN.js","/next/assets/css-color-BHGmDLuf.js","/next/assets/default-font-stacks-CR8VpmhK.js","/next/assets/dist-CYDxXfI1.js","/next/assets/draft-route-components-DaUKXXw6.js","/next/assets/draft-runtime-registry-U4JRGosJ.js","/next/assets/drawer-BpMvCbuK.css","/next/assets/drawer-CZQ8OuaP.js","/next/assets/epic-canvas-pointer-sensor-WV6kLFNy.js","/next/assets/epic-shell-DLioOiRN.css","/next/assets/epic-shell-DfMl_2bA.js","/next/assets/epic-tab-route-components-CK1aE3jU.js","/next/assets/epics-layout-route-components-BrmNjBl5.js","/next/assets/epics-list-panel-QoLVPx1J.js","/next/assets/esm-ByNXMVqP.js","/next/assets/esm-Ca3eMxMG.js","/next/assets/file-path-tooltip-zXRUrzm9.js","/next/assets/format-duration-BYw8LYlX.js","/next/assets/home-touch-targets-8S_VdgRA.js","/next/assets/home-touch-targets-D_g498SO.css","/next/assets/host-D7-F3wmP.js","/next/assets/host-update-banner-store-BWKf3Zv8.js","/next/assets/index-BzMfybHh.js","/next/assets/index-DWhrpUo9.css","/next/assets/jsx-runtime-Ciaf_P-h.js","/next/assets/mobile-terminal-key-bar-WAb4nY1O.js","/next/assets/pane-activation-Dz9M24JR.js","/next/assets/preload-helper-CCH5zA4s.js","/next/assets/purify.es-CaHOtzI7.js","/next/assets/read-error-message-C44IcqmB.js","/next/assets/rolldown-runtime-B0Z9INg1.js","/next/assets/root-landing-page-DO9iLOMq.js","/next/assets/settings-modal-content-Db5PLaIv.js","/next/assets/sheet-BDBxI9Nm.js","/next/assets/snapshot-loading-context-BS-eSnwh.js","/next/assets/src-B-DeWB10.js","/next/assets/start-truncated-text-CUdIRVqo.js","/next/assets/sweep-worktrees-dialog-DbxDXrww.js","/next/assets/tab-surface-activity-context-B7JYwiuO.js","/next/assets/terminal-focus-registry-CxSnAGOh.js","/next/assets/terminal-key-input-registry-d7Jr-UtW.js","/next/assets/tile-find-adapter-context-C1A0oEqj.js","/next/assets/unavailable-epic-DwtAcIVq.js","/next/assets/use-clipboard-copy-vRZh8tf8.js","/next/assets/use-code-mirror-theme-BGVlJgAB.js","/next/assets/use-durable-stream-transport-CT_Mlwrl.js","/next/assets/use-epic-title-mutation-B2ed8fyI.js","/next/assets/use-providers-ensure-pack-mutation-DFKPUuLo.js","/next/assets/use-providers-set-env-override-mutation-DYJn8mP9.js","/next/assets/use-worktree-delete-stream-transport-CFlPIS5W.js","/next/assets/useStore-DBnRaLUW.js","/next/assets/utils-qd7bcQVw.js","/next/assets/v4-DDdyfk2q.js","/next/assets/value-Cwm0ChEK.js","/next/assets/w3c-keyname-BOAvb0qz.js","/next/assets/windows-bridge-context-CDSC6j5t.js","/next/assets/worktree-pr-metadata-D8tlVSKD.js","/next/index.html","/next/manifest.webmanifest"];
"use strict";
/**
...
sw.addEventListener("message", (event) => {
    ...
    if (data?.type === NOTIFICATION_CLIENT_READY) {
        ...
        if (event.source !== null)
            flushPendingClicksTo(event.source);
    }
 ...
 */
async function waitForAck(id, target) {
    const deadline = Date.now() + CLICK_DELIVERY_TIMEOUT_MS;
    for (;;) {
        if (!pendingClicks.some((entry) => entry.id === id))
            return;
...
sw.addEventListener("push", (event) => {
    ...
    if (parsed === null)
        return;
    event.waitUntil(sw.registration.showNotification(parsed.title, {
        body: parsed.body,
        data: parsed.payload,
...
function parsePush(data) {
    ...
    return {
        ...
        replaceKey: typeof record.replaceKey === "string" ? record.replaceKey : null,
    };
}
